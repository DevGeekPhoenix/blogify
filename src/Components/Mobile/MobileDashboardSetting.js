  ...
  return (
    <>
      ...
      <div
        ...
        className={`md:hidden fixed right-3 flex justify-center items-center w-14 h-14 rounded-full shadow-xl bg-[#c2c2c2] transition-transform duration-500
        ${isSettingMenuOpen ? " bottom-3 -translate-y-16" : " bottom-3 "}
        `}
      >
      ...
      <div
        className={`md:hidden fixed right-3 flex justify-center items-center w-14 h-14 rounded-full shadow-xl bg-[#c2c2c2] transition-transform duration-500
        ${isSettingMenuOpen ? " bottom-3 -translate-y-32 " : " bottom-3 "}
        `}
      >
      ...
      <Link to="newblog">
        <div
          className={`md:hidden fixed right-3 flex justify-center items-center w-14 h-14 rounded-full shadow-xl bg-[#c2c2c2] transition-transform duration-500
        ${isSettingMenuOpen ? " bottom-3 -translate-y-48" : " bottom-3 "}
        `}
        >
          <Pen />
        </div>
